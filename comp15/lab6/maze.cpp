...
bool Maze::solve(Position p)
{
        ...
        if(mazeAt(p.north()) == ' '){         
            cerr << "About to check North" << endl;
            if(solve(p.north())==true){
                return true;
            }

        }
        else if(mazeAt(p.east()) == ' '){
           cerr << "About to check East" << endl; 
           if(solve(p.east())==true){
               return true;
           }
        }
        else if(mazeAt(p.south()) == ' '){
           cerr << "About to check South" << endl;
           if(solve(p.south())==true){
               return true;
           }
        }
        else if(mazeAt(p.west()) != ' '){
           cerr << "About to check West" << endl;
           if(solve(p.west())==true){
               return true;
           }           
        }
